<header class="navbar navbar-dark sticky-top flex-md-nowrap p-0 shadow fixed-top" style="background-color: #0F0071">
    ...
    <div class="navbar-nav flex-row ms-auto me-md-0">
        ...
        <div class="nav-item text-nowrap">
            <a class="nav-link px-3 text-white" href="{{ route('manager.logout') }}"
