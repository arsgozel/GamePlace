...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div>
            <a href="{{ route('manager.devices.create') }}" class="btn btn-danger btn-sm">
        ...
        <table class="table table-hover table-striped table-bordered">
            ...
            @foreach($objs->sortBy('sort_order')->sortBy('parent.sort_order') as $obj)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('manager.devices.index', $obj->slug) }}" class="text-decoration-none">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <form action="{{ route('manager.devices.destroy', $obj->id) }}" method="post">
                                            @method('DELETE')
                                            @csrf
                                            @honeypot
